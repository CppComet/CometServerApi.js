...
getCookie(this.options.CometUserid);if(!this.options.dev_id)console.error("CometServerApi:\u041d\u0435 \u0443\u043a\u0430\u0437\u0430\u043d dev_id");if(!this.server)this.server=new CometServerApi(this.options);return this.server};